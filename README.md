...
3. Get the latest price information for apps
   ...
   2. Based on the app details link obtained in the previous step, parse the link to get the price of  `In-App Purchases` （Data scraping powered by [Scrapeless](https://www.scrapeless.com/en "Scrapeless - Effortless Web Scraping Toolkit for Business and Developers") ）
